  ...
  const inner = (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="font-sans text-sm text-brand-textsec leading-relaxed">
          {children}
        </div>
      </div>
      {href && (
    ...
    <PageWrapper>
      ...
      <div className="pt-32 pb-20 bg-brand-surface relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to left, rgba(154,114,40,0.04), transparent)",
          }}
        />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <motion.h1
              variants={fadeInUp}
              className="font-display text-display-lg text-brand-text mb-5"
            >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <h2 className="font-display text-display-md text-brand-text mb-5">
                So erreichen
                <br />
                Sie uns
              </h2>
              <p className="font-sans font-light text-brand-muted leading-relaxed mb-8">
                Sie können uns telefonisch oder per E-Mail kontaktieren. Wir
                melden uns innerhalb von{" "}
                <strong className="text-brand-textsec font-medium">
                  [Zeitraum, z.B. 24 Stunden]
                </strong>{" "}
                bei Ihnen zurück.
              </p>
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-sans text-[9px] font-semibold tracking-[0.2em] uppercase text-brand-muted mb-0.5 group-hover:text-brand-gold transition-colors">
                          {item.label}
                        </p>
                        <p className="font-sans text-sm text-brand-textsec">
                          {item.val}
                        </p>
                      </div>
                    </div>
                    <svg
                      className="w-4 h-4 text-brand-gold opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            >
              ...
              <div className="bg-brand-surface border border-brand-border p-8">
                ...
                <address className="not-italic font-sans text-sm text-brand-textsec leading-loose">
              ...
              <div className="border-l-4 border-brand-gold bg-brand-gold-pale p-6">
                <p className="font-sans text-xs text-brand-textsec leading-relaxed">
                  <strong className="text-brand-text font-semibold">
                    Datenschutzhinweis:
                  </strong>{" "}
                  Ihre Kontaktdaten werden ausschließlich zur Beantwortung Ihrer
                  Anfrage verwendet und nicht an Dritte weitergegeben. Weitere
                  Informationen entnehmen Sie unserer{" "}
                  <Link
                    to="/datenschutz"
