        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <Link to="/" className="block mb-4">
              <span className="font-display text-2xl text-brand-cream">{CLIENT.firmenname}</span>
          ...
          <div>
            ...
            <address className="not-italic space-y-3">
              ...
              <a href={`tel:${CLIENT.telefon}`}
                ...
                <svg className="w-4 h-4 text-brand-gold-dim group-hover:text-brand-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
